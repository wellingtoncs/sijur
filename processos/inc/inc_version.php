...
$flag_imagick = function_exists("imagick_readimage");	// http://pear.sourcefclientee.net/en/packages.imagick.php
...
class Link {
	...
	// (se não o valor é fornecido, tomamos o valor global da variável)
	...
	// (variável cujo nome é arbitrariamente longo, e cujo valor é 
	// transmitida de link em link. Limitada a 5 variáveis)
	...
	//
	// Buscar o URL associado com o link
