...
function init_default_config() {
	...
	$list_meta = array(
		...
		// ** Policy **
		'adverso_name_middle' => $meta_name_middle,
		'adverso_citizen_number' => 'no',
		'adverso_cpfcnpj' => 'no',
		'adverso_civil_status' => 'no',
		'adverso_income' => 'no',
		'adverso_hide_all' => 'no',
		'adverso_share_read' => 'yes', // depends on hide_all
		'adverso_share_write' => 'yes', // depends on read = yes
		'adverso_date_birth' => 'no', // = { yes_optional, yes_mandatory, no }
		'person_name_format' => '1', // First Middle Last (ex: Ivan Petrov Ivanov)
		'cliente_hide_all' => 'no',
		'cliente_share_read' => 'yes', // depends on hide_all
		'cliente_share_write' => 'yes', // depends on read = yes
		...
		'case_comarca' => 'yes_optional', // = { yes_optional, yes_mandatory, no }
		'case_legal_reason' => 'yes_optional', // = { yes_optional, yes_mandatory, no }
		'case_p_cliente' => 'yes_optional', // = { yes_optional, yes_mandatory, no }
		'case_new_showcliente' => 'no', // = { yes, no } shows 'find/create cliente' form in 'new case'
