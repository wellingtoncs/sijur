...
$placa = $_GET['placa_t'].$_GET['placa_n'];
...
if($placa!=""){
	...
	while($wr = mysql_fetch_array($qr)){
		...
		if(mysql_num_rows($qdilig)==0){
			...
			if($tipodeacao=='BUSCA_E_APREENSAO' || $tipodeacao=='BUSCAEAPREENS_O' || $tipodeacao=='REINTEGRA_ODEPOSSE' || $tipodeacao==''){
