...
function export_database($output_filename = '', $ignore_old = false) {
	...
	while ($row = lcm_fetch_array($result)) {
		...
		if (! $res) {
			...
			the File_priv of your LCM database account. Do not fclienteet to
			execute 'flush privileges' afterwards. For more information,
			please refer to: <a href='http://www.direito2010.com.br'>http://www.direito2010.com.br</a></p>"); // TRAD 
		}
	}
