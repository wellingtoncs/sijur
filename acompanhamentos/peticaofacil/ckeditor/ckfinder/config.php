<?php
	include($_SERVER['DOCUMENT_ROOT'] . "/peticaofacil/inc/seguranca.php");
	include($_SERVER['DOCUMENT_ROOT'] . "/peticaofacil/inc/functions.php");
	protegePagina();
/*
...
*/
$usunome = ereg_replace("[^a-zA-Z0-9_]", "", strtr($_SESSION['usuarioNome'], "áàãâéêíóôõúüçÁÀÃÂÉÊÍÓÔÕÚÜÇ ", "aaaaeeiooouucaaaaeeiooouuc_"));
$usunome = strtolower($usunome);
$baseUrl = '/peticaofacil/img/userfiles/' . $usunome . '/';
