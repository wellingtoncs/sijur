...
function show_keyword_group_id($id_group, $id_parent = 0) {
	...
	if ($kwg['type'] == 'system' || $kwg['type'] == 'contact' || $id_parent) {
		...
		$all_types = array("case", "stage", "followup", "adverso", "cliente", "adverso_cliente");  // "author"
...
switch (_request('action')) {
	...
	case 'refresh':
		...
		$_SESSION['info']['refresh'] = _T('keywords_cache_refreshed'); // TRAD
...
///FT Ocultar a Informação de Ajuda\/\/\/\/
