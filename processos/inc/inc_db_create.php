...
function create_database() {
	...
	$fields = array (
		...
		"prefs text",
		"status ENUM('admin', 'normal', 'manager', 'external', 'trash', 'waiting', 'suspended') NOT NULL DEFAULT 'normal'",
	...
	$fields = array (
		"id_adverso bigint(21) NOT NULL auto_increment",
		"name_first text",
		"name_middle text",
		"name_last text",
		"date_creation datetime NOT NULL",
	...
	lcm_query_create_table('lcm_adverso', $fields);
	...
	lcm_query_create_table('lcm_adverso_attachment', $fields, $keys);


	$fields = array (
		"id_cliente bigint(21) NOT NULL auto_increment",
		"name text",
	...
	lcm_query_create_table('lcm_cliente', $fields);
	...
	lcm_query_create_table('lcm_cliente_attachment', $fields, $keys);


	$fields = array (
		"id_contact bigint(21) NOT NULL auto_increment",
		"type_person ENUM('author', 'adverso', 'cliente') NOT NULL",
	...
	lcm_query_create_table('lcm_keyword_adverso', $fields, $keys);
	...
	lcm_query_create_table('lcm_keyword_cliente', $fields, $keys);
	...
	$fields = array (
		...
		"title text NOT NULL",
		"description text",
		"type ENUM('system', 'contact', 'case', 'stage', 'followup', 'adverso', 'cliente', 'adverso_cliente', 'author') NOT NULL",
	...
	$fields = array (
		...
		"id_adverso bigint(21) NOT NULL DEFAULT 0", // may be 0, if app with cliente
		"id_cliente bigint(21) NOT NULL DEFAULT 0" // may be 0, if app with adverso
	);

	lcm_query_create_table('lcm_app_adverso_cliente', $fields);
	lcm_query_create_unique_index('lcm_app_adverso_cliente', 'idx_uniq', 'id_app,id_adverso,id_cliente');
	...
	$fields = array (
		"id_case bigint(21) NOT NULL",
		"id_adverso bigint(21) DEFAULT 0 NOT NULL",
		"id_cliente bigint(21) DEFAULT 0 NOT NULL"
	);
	...
	lcm_query_create_table('lcm_case_adverso_cliente', $fields, $keys);
	lcm_query_create_unique_index('lcm_case_adverso_cliente', 'idx_uniq', 'id_case,id_adverso,id_cliente');
	...
	lcm_query_create_table('lcm_adverso_cliente', $fields, $keys);
	lcm_query_create_unique_index('lcm_adverso_cliente', 'idx_uniq', 'id_adverso,id_cliente');
