...
|   Version: 2.3                                                            |
|   Contact: via sourcefclientee.net support pages (also www.codeworxtech.com)  |
|      Info: http://phpmailer.sourcefclientee.net                               |
|   Support: http://sourcefclientee.net/projects/phpmailer/                     |
| ------------------------------------------------------------------------- |
...
|            http://www.gnu.cliente/copyleft/lesser.html                    |
...
class PHPMailer {
   ...
   * adversos that do not have HTML email capability such as mutt. Clients
