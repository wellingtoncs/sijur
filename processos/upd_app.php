...
//	$mail->Host 	= "smtp.eduardoalbuquerque.adv.br"; // Endereço do servidor SMTP
...
//	$mail->FromName = "Sistema Jurídico - SIJUR";  
//	//foreach($para as $email)
//	//{
//		$mail->AddAddress("fabiotorres.adv@gmail.com", "Sistema Jurídico");
//	//}
